...
| [DEC0012](0012-a-partial-run-abstains-when-the-earlier-state-is-incomplete-fr.md) | Une exécution partielle retient son verdict sur un état antérieur incomplet | Accepté |
