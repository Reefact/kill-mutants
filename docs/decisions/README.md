...
| [DEC0012](0012-a-partial-run-abstains-when-the-earlier-state-is-incomplete-en.md) | A partial run withholds its verdict over an incomplete earlier state | Accepted |
